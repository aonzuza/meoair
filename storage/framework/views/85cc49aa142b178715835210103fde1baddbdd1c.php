...
<html>
  <head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('admin/styles/sortableStyle.css')); ?>" > -->

    <?php echo $__env->yieldContent('style'); ?>

  </head>
  <body>
    <?php echo $__env->make('admin.inc.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /* C:\xampp\htdocs\meoair\resources\views/admin/layouts/app.blade.php */ ?>