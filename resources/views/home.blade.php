    ...
    <!--  -->
      <div class="row home-first-text-wrapper">
        ...
        <div class="col-12 col-sm-8 offset-sm-2 col-lg-4 offset-lg-0">
            ...
            <div class="home-sm-image-wrapper">
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-lg-8 offset-lg-0">
              ...
              <p>
                  นวัตกรรมใหม่จากประเทศญี่ปุ่น ที่เปลี่ยนอากาศรอบตัวเราให้เป็นออกซิเจนบริสุทธิ์ สะอาด ด้วย
                  เทคโนโลยที่ได้สิทธิบัตรเฉพาะ OXY’Z เท่านั้น – “ Zeolite Cartridge ” – ด้วยคุณสมบัติจากแร่
                  ธรรมชาติซิโอไลท์ ทำให้สามารถผลิตออกซิเจนได้มากกว่าทั่วไปถึง 2 เท่า นอกจากนี้ยังสามารถปล่อย
                  ไอออนลบให้เข้าไปจับฝุ่นรอบตัว เพื่อช่วยให้อากาศโดยรอบสะอาดยิ่งขึ้น ตัวเครื่องมีน้ำหนัก เบา และ
                  ง่ายต่อการพกพา สามารถใช้ได้ทุกที่ในบ้าน ออฟฟิต สถานที่ออกกำลังกาย หรือแม้กระทั่งบนรถ
              </p>
      ...
      <div class="first-row-img-wrapper">
              <!-- <img src="https://dummyimage.com/1920x800/000000/fffffff" /> -->
              <video id="home-video-player" width="100%" height="auto"  controls>
      ...
      <div class="container-fluid">
          ...
          <div class="row home-first-text-wrapper">
                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-lg-4 offset-lg-0">
                  <div class="home-sm-image-wrapper d-flex align-items-center" style="height:100%;">
                      <img src="https://dummyimage.com/400x400/000000/fffffff" />
                  </div>
                </div>
